...
public class DynamicBeat extends JFrame {
    ...
    private void initUI() {
        setUndecorated(true);
        setTitle("Dynamic Beat");
        setSize(dynamic_beat_7.Main.SCREENT_WIDTH , dynamic_beat_7.Main.SCREENT_HEIGHT);
        setResizable(false);
        setLocationRelativeTo(null);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setVisible(true);
        ...
        // 노래 데이터 가변적으로 삽입
        String[][] trackData = {
            {"Mighty Love Title Image.png", "Mighty Love Start Image.png", "Mighty Love Game Image.png", "Mighty Love Selected.mp3", "Joakim Karud - Mighty Love.mp3"},
            {"Wild Flower Title Image.png", "Wild Flower Start Image.png", "Wild Flower Game Image.png", "Wild Flower Selected.mp3", "Joakim Karud - Wild Flower.mp3"},
            {"Energy Title Image.png", "Energy Start Image.png", "Energy Game Image.png", "Energy Selected.mp3", "Bensound - Energy.mp3"}
        };

        for (String[] track: trackData) {
            trackList.add(new Track(track[0], track[1], track[2], track[3], track[4]));
        }
    }
    ...
    @Override
    public void paint(Graphics g) {
        screenImage = createImage(dynamic_beat_7.Main.SCREENT_WIDTH, dynamic_beat_7.Main.SCREENT_HEIGHT);
        screenGraphic = screenImage.getGraphics();
        screenDraw(screenGraphic);
        g.drawImage(screenImage, 0, 0, null);
    }

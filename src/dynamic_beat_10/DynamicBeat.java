...
public class DynamicBeat extends JFrame {
    ...
    private final Image GameInfoImage = new ImageIcon(
            Main.class.getResource("../images/GameInfo.png")).getImage();
    private final Image JudgementLineImage = new ImageIcon(
            Main.class.getResource("../images/JudgementLine.png")).getImage();
    private final Image NoteRouteImage = new ImageIcon(
                Main.class.getResource("../images/NoteRoute.png")).getImage();
    private final Image NoteRouteLineImage = new ImageIcon(
                Main.class.getResource("../images/NoteRouteLine.png")).getImage();
    private final Image NoteBasicImage = new ImageIcon(
    ...
    private void initUI() {
        ...
        String[][] trackData = {
                ...
                { "Wild Flower Title Image.png", "Wild Flower Start Image.png", "Wild Flower Game Image.jpg",
                        "Wild Flower Selected.mp3", "Joakim Karud - Wild Flower.mp3" },
    ...
    private void screenDraw(Graphics g) {
        ...
        if (isGameScreen) {
            ...
            g.drawImage(NoteRouteImage, 644, 30, null);
            g.drawImage(NoteRouteImage, 748, 30, null);
    ...
    public void gameStart(int nowSelected, String difficulty) {
        ...
        // System.out.println(trackList.get(nowSelected).getGameImage());

...
public class DynamicBeat extends JFrame {
    ...
    private void initUI() {
        ...
        String[][] trackData = {
                { "Mighty Love Title Image.png", "Mighty Love Start Image.png", "Mighty Love Game Image.jpg",
                        "Mighty Love Selected.mp3", "Mighty Love Selected.mp3","Joakim Karud" },
                { "Wild Flower Title Image.png", "Wild Flower Start Image.png", "Wild Flower Game Image.jpg",
                        "Wild Flower Selected.mp3", "Wild Flower Selected.mp3", "Joakim Karud" },
    ...
    public void gameStart(int nowSelected, String difficulty) {
        ...
        isGameScreen = true;
        setFocusable(true);
        game = new Game(trackList.get(nowSelected).getTitleImage(), difficulty, trackList.get(nowSelected).getGameMusic());
    }

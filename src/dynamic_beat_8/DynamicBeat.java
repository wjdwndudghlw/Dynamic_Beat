...
public class DynamicBeat extends JFrame {
    ...
    private void initUI() {
        setUndecorated(true);
        setTitle("Dynamic Beat");
        setSize(dynamic_beat_8.Main.SCREENT_WIDTH, dynamic_beat_8.Main.SCREENT_HEIGHT);
        setResizable(false);
        setLocationRelativeTo(null);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setVisible(true);
        ...
        String[][] trackData = {
                ...
                { "Wild Flower Title Image.png", "Wild Flower Start Image.png", "Wild Flower Game Image.png",
    ...
    @Override
    public void paint(Graphics g) {
        screenImage = createImage(dynamic_beat_8.Main.SCREENT_WIDTH, dynamic_beat_8.Main.SCREENT_HEIGHT);
        screenGraphic = screenImage.getGraphics();
        screenDraw(screenGraphic);
        g.drawImage(screenImage, 0, 0, null);
    }
